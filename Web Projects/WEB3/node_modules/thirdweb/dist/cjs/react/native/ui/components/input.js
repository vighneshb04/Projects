...
function ThemedInput(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(react_native_1.View, { style: [
        ...
        ], children: [leftView && leftView, (0, jsx_runtime_1.jsx)(react_native_1.TextInput, { placeholderTextColor: theme.colors.secondaryText, style: [
                    styles.input,
                    { color: theme.colors.primaryText },
                    leftView ? { paddingLeft: 0 } : {},
                ], onFocus: () => setIsFocused(true), onBlur: () => setIsFocused(false), ...props }), rightView && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(react_native_1.View, { style: { flex: 1 } }), rightView] }))] }));
}
