...
function useAutoConnect(props) {
    return (0, useAutoConnect_js_1.useAutoConnectCore)(nativeStorage_js_1.nativeLocalStorage, {
        ...props,
        wallets: props.wallets || (0, defaultWallets_js_1.getDefaultWallets)(props),
