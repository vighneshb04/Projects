...
export function ThemedInput(props) {
    ...
    return (_jsxs(View, { style: [
        ...
        ], children: [leftView && leftView, _jsx(TextInput, { placeholderTextColor: theme.colors.secondaryText, style: [
                    styles.input,
                    { color: theme.colors.primaryText },
                    leftView ? { paddingLeft: 0 } : {},
                ], onFocus: () => setIsFocused(true), onBlur: () => setIsFocused(false), ...props }), rightView && (_jsxs(_Fragment, { children: [_jsx(View, { style: { flex: 1 } }), rightView] }))] }));
}
